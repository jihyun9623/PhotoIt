...
public class MainPagePhotoDetailRes extends BaseResponseBody {
    ...
    public static MainPagePhotoDetailRes of(Integer statusCode, String message, String origin, String[] tagList, Boolean favorite, List<ThumbPhotoIdRes> thumbPhotoIds) {
