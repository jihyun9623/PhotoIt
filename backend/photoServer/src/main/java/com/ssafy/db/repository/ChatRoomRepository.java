...
import com.ssafy.common.chat.RedisSubscriber;
...
public class ChatRoomRepository {
    ...
    public ChatRoomDto createChatRoom(String user1, String user2) {
        ...
        if(opsHashChatRoom.get(CHAT_ROOMS, name)==null) {
            ChatRoomDto chatRoom = ChatRoomDto.create(user1_.getId(), user2_.getId());
            opsHashChatRoom.put(CHAT_ROOMS, chatRoom.getName(), chatRoom);
            ...
            TempChatRoom tempChatRoom = TempChatRoom.builder()
                                        .roomName(opsHashChatRoom.get(CHAT_ROOMS, name).getName())
                                        .build();
            roomRepository.save(tempChatRoom);
            return opsHashChatRoom.get(CHAT_ROOMS, name);
        }
    }
